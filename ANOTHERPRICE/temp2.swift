...
struct temp2: View {
    ...
    var body: some View {
        VStack{
            ...
            ScrollView{
                ForEach(0..<5) { _ in
                    UIComplexIssueCard(destination: tempView(), title: "標題", date: "2025-09-04", coin: 344, content: "好東西", like: true, heart: heart, message: message, author: author, code: code, http: http)
                }
            }
        }
    }
