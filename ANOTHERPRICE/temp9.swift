    ...
    var body: some View {
        VStack{
            ...
            ScrollView {
                ...
                UIComplexMessageLeft(userAvatar: userAvatar, content: "對話內容")
                UIComplexMessageLeft(userAvatar: userAvatar, content: "對話內容")
                UIComplexMessageRight(userAvatar: userAvatar, content: "對話內容對話內容對話內容對話內容對話內容對話內容")
                UITextMessageDate(date: "0225-04-21")
                UIComplexMessageRight(userAvatar: userAvatar, content: "對話內容")
                UIComplexMessageLeft(userAvatar: userAvatar, content: "對話內容")
                UIComplexMessageLeft(userAvatar: userAvatar, content: "對話內容")
            }
